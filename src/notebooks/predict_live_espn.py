    ...
    try:
        while True:
            ...
            try:
                ...
                # Filter to only new plays we haven't seen
                ...
                # Filter out rows with NaN values in required features
...
def main():
    ...
    if args.output_dir:
        ...
        output_dir = ROOT / "data" / "live" / "espn"

    # Start polling and predicting
    predict_from_espn(
